...
export const TIMEZONE_DATABASE: TimezoneInfo[] = [
  ...
  { id: 'us-pacific', label: 'PT', city: 'Los Angeles', iana: 'America/Los_Angeles', aliases: ['San Francisco', 'Seattle', 'Portland', 'San Jose', 'San Diego', 'Las Vegas', 'Sacramento', 'Oakland'] },
  { id: 'us-mountain', label: 'MT', city: 'Denver', iana: 'America/Denver', aliases: ['Salt Lake City', 'Boise', 'Albuquerque', 'Colorado Springs'] },
  { id: 'us-arizona', label: 'MST', city: 'Phoenix', iana: 'America/Phoenix', aliases: ['Tucson', 'Mesa', 'Scottsdale'] },
  { id: 'us-central', label: 'CT', city: 'Chicago', iana: 'America/Chicago', aliases: ['Houston', 'Dallas', 'Austin', 'San Antonio', 'Minneapolis', 'Nashville', 'Memphis', 'Milwaukee', 'Kansas City', 'New Orleans'] },
  { id: 'us-eastern', label: 'ET', city: 'New York', iana: 'America/New_York', aliases: ['Boston', 'Washington DC', 'Miami', 'Atlanta', 'Philadelphia', 'Detroit', 'Charlotte', 'Pittsburgh', 'Orlando', 'Tampa', 'Baltimore', 'Columbus', 'Indianapolis', 'Cleveland', 'Raleigh'] },
  ...
  { id: 'uk', label: 'GMT/BST', city: 'London', iana: 'Europe/London', aliases: ['Edinburgh', 'Manchester', 'Birmingham'] },
  { id: 'ireland', label: 'IST', city: 'Dublin', iana: 'Europe/Dublin' },
  { id: 'central-europe', label: 'CET', city: 'Berlin', iana: 'Europe/Berlin', aliases: ['Munich', 'Frankfurt', 'Hamburg'] },
  { id: 'france', label: 'CET', city: 'Paris', iana: 'Europe/Paris', aliases: ['Lyon', 'Marseille'] },
  { id: 'spain', label: 'CET', city: 'Madrid', iana: 'Europe/Madrid', aliases: ['Barcelona', 'Valencia'] },
  { id: 'italy', label: 'CET', city: 'Rome', iana: 'Europe/Rome', aliases: ['Milan', 'Naples'] },
  { id: 'netherlands', label: 'CET', city: 'Amsterdam', iana: 'Europe/Amsterdam', aliases: ['Rotterdam'] },
  { id: 'switzerland', label: 'CET', city: 'Zurich', iana: 'Europe/Zurich', aliases: ['Geneva', 'Bern'] },
  { id: 'sweden', label: 'CET', city: 'Stockholm', iana: 'Europe/Stockholm' },
  { id: 'norway', label: 'CET', city: 'Oslo', iana: 'Europe/Oslo' },
  { id: 'denmark', label: 'CET', city: 'Copenhagen', iana: 'Europe/Copenhagen' },
  { id: 'poland', label: 'CET', city: 'Warsaw', iana: 'Europe/Warsaw', aliases: ['Krakow'] },
  { id: 'austria', label: 'CET', city: 'Vienna', iana: 'Europe/Vienna' },
  { id: 'czech', label: 'CET', city: 'Prague', iana: 'Europe/Prague' },
  { id: 'portugal', label: 'WET', city: 'Lisbon', iana: 'Europe/Lisbon', aliases: ['Porto'] },
  { id: 'romania', label: 'EET', city: 'Bucharest', iana: 'Europe/Bucharest' },
  { id: 'ukraine', label: 'EET', city: 'Kyiv', iana: 'Europe/Kyiv' },
  ...
  { id: 'china', label: 'CST', city: 'Shanghai', iana: 'Asia/Shanghai', aliases: ['Guangzhou', 'Shenzhen', 'Chengdu'] },
  { id: 'china-beijing', label: 'CST', city: 'Beijing', iana: 'Asia/Shanghai', aliases: ['Tianjin'] },
  ...
  { id: 'japan', label: 'JST', city: 'Tokyo', iana: 'Asia/Tokyo', aliases: ['Osaka', 'Kyoto', 'Yokohama'] },
  ...
  { id: 'canada-pacific', label: 'PT', city: 'Vancouver', iana: 'America/Vancouver', aliases: ['Victoria'] },
  { id: 'canada-central', label: 'CT', city: 'Winnipeg', iana: 'America/Winnipeg' },
  { id: 'canada-eastern', label: 'ET', city: 'Toronto', iana: 'America/Toronto', aliases: ['Ottawa', 'Montreal'] },
  { id: 'canada-mountain', label: 'MT', city: 'Edmonton', iana: 'America/Edmonton', aliases: ['Calgary'] },
  { id: 'peru', label: 'PET', city: 'Lima', iana: 'America/Lima' },
  { id: 'ecuador', label: 'ECT', city: 'Quito', iana: 'America/Guayaquil' },
  { id: 'venezuela', label: 'VET', city: 'Caracas', iana: 'America/Caracas' },
  { id: 'morocco', label: 'WET', city: 'Casablanca', iana: 'Africa/Casablanca' },
  { id: 'ethiopia', label: 'EAT', city: 'Addis Ababa', iana: 'Africa/Addis_Ababa' },
  { id: 'ghana', label: 'GMT', city: 'Accra', iana: 'Africa/Accra' },
  { id: 'qatar', label: 'AST', city: 'Doha', iana: 'Asia/Qatar' },
  { id: 'kuwait', label: 'AST', city: 'Kuwait City', iana: 'Asia/Kuwait' },
];
